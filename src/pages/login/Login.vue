<template>
  <div class="login-box height100 width100 ">
    ...
    <div class="login-middle mg-center display-row ai-c ">
      ...
      <div class="login-control pd-30">
        <h3 class=" fs24">登录</h3>
        <div class="login-accout-form display-col">
          <mt-field placeholder="请输入账号/用户名"
                    type="username"
                    :disableClear="true"
                    :handler-key-enter="goLogin"
                    v-model="inputAccountModel">
            <img src="../../assets/account-filling (1).png"
                 height="20"
                 width="20"></mt-field>
