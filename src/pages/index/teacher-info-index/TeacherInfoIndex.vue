<template>
  ...
  <el-row :gutter="20" class="mg-top10 mg-left10 mg-bottom10">
    <el-col :span="6">教师姓名：<el-input style="width:200px;" v-model="searchTeacherName" placeholder="请输入教师姓名"></el-input></el-col>
  <el-col :span="6">教师职称：<el-input  style="width:200px;"  v-model="searchTeacherTitle" placeholder="请输入教师职称"></el-input></el-col>
  </el-row>
