<template>
  <div class="TeacherInfoIndex-box">
    ...
    <el-row :gutter="20" class="mg-top10 mg-left10 mg-bottom10">
      ...
      <el-col :span="6">教师职称：
        <el-input v-model="searchTitle" placeholder="请输入用户职称" style="width:200px;"></el-input>
      </el-col>
      <el-col :span="6">用户账号：
        <el-input v-model="searchUsername" placeholder="请输入用户账号" style="width:200px;"></el-input>
      </el-col>
    </el-row>
