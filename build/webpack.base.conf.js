...
var webpackConfig = {
  ...
  postcss: function () {
    return [
      ...
      stylelint({failOnError: true})
    ]
  },
  module: {
    // preLoaders: [   {     test: /\.vue$/,     loader: 'eslint',     include: [
    // path.join(projectRoot, 'src')     ],     exclude: /node_modules/   },   {
    // test: /\.js$/,     loader: 'eslint',     include: [ path.join(projectRoot,
    ...
    loaders: [
      {
        ...
        test: /\.css$/, // 如果使用了 ExtractTextPlugin 	// loader:
        // ExtractTextPlugin.extract('style', 'css!postcss') // 否则
        include: [path.resolve(__dirname, "not_exist_path")],
        loader: "style-loader!css-loader!postcss-loader"
      },
      // {   test: /\.css$/,   loader: "style-loader!css-loader" }, {   test:
